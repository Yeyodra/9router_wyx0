...
Vitest-based test suite with unique conventions: data-driven matrix testing, `it.fails()` bug tracking, and tiered test categories.
...
├── unit/                   # Offline unit tests (65 files)
